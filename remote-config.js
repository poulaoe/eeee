(function () {
  ...
  var DEFAULT_ANON_KEY =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inludmt4dWRtdXNmYWl2Y3Jram94Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODIyNDE3MDYsImV4cCI6MjA5NzgxNzcwNn0._XgvmdHq6KeT1K2-xpvML7HIF8GimRegl14DhMsBp8E";
  ...
  function readAnonKey() {
    try {
      return (
        localStorage.getItem(ANON_KEY_STORAGE) || DEFAULT_ANON_KEY
      ).trim();
    } catch (e) {
